"""fist_man_19555 URL Configuration
...
admin.site.site_header = "fist man"
admin.site.site_title = "fist man Admin Portal"
admin.site.index_title = "fist man Admin"

# swagger
api_info = openapi.Info(
    title="fist man API",
    default_version="v1",
    description="API documentation for fist man App",
)
